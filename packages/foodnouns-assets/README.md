...
```ts
import { ImageData } from '@foodnouns/assets';
...
```ts
import { getNounData } from '@foodnouns/assets';
...
```ts
import { getNounSeedFromBlockHash } from '@foodnouns/assets';
...
import { ImageData, getNounSeedFromBlockHash, getNounData } from '@foodnouns/assets';
