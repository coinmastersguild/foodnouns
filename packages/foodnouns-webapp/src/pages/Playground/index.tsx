...
import { ImageData, getNounData, getRandomNounSeed } from '@foodnouns/assets';
...
const nounsAssetsLink = (
  <Link
    text="foodnouns-assets"
    url="https://github.com/nounsDAO/nouns-monorepo/tree/master/packages/foodnouns-assets"
    leavesPage={true}
  />
);
...
const nounsSDKLink = (
  <Link
    text="foodnouns-sdk"
    url="https://github.com/nounsDAO/nouns-monorepo/tree/master/packages/foodnouns-sdk"
    leavesPage={true}
  />
);
